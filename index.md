...
> This page is an aggregator of the different versions of the CVs belonging to Pão ([paodelonga](https://pao.grinmaldis.space)).
>
...
> -------------------------------------------------------------------------------------------
>
> Esta página é um agregador das diferentes versões dos curriculos pertencentes a Pão ([paodelonga](https://pao.grinmaldis.space))
>
