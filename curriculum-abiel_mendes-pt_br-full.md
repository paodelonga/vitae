...
- Otimizei a infraestrutura de TI, realocando e mantendo computadores com foco em desempenho e durabilidade.
- Implantei cabeamento estruturado, configurando switches, roteadores e pontos de acesso, reduzindo falhas de conectividade em X%.
- Documentei a infraestrutura de rede, garantindo conformidade e facilidade de manutenção.
- Contribuí para a digitalização do acervo, agilizando o acesso a informações.

**STAFF, Monitor - Maratona de Programação (Hackaton)**
_INCODE Tech School - Trainee_ – São Luís, MA
_09/2024 – 09/2024_

- Acompanhamento e suporte técnico às equipes durante os desafios;
- Garantia do cumprimento das regras e obrigações do evento;
- Auxílio em questões logísticas e organização do espaço;
- Promoção de um ambiente adequado e seguro para todos os participantes.
...
## Habilidades e Interesse Técnicas
...
- Sistemas Operacionais: NixOS, Linux Desktop & Server (Ubuntu, Debian, Archlinux, CentOS), Windows as Desktop, Shell Scripting.
